...
const ContactPage = () => {
  ...
  const seoData = {
    title: "Contact IA Center | Centre Formation IA | Devis Formation | Paris",
    description: "Contactez IA Center pour vos formations IA entreprises et particuliers. Centre de formation intelligence artificielle certifié Qualiopi. Paris 75011. Tél: 05 67 80 25 40. Devis gratuit.",
    keywords: "contact IA Center, devis formation IA, contact formation intelligence artificielle, centre formation IA Paris, organisme formation IA contact, inscription formation IA, demande formation OPCO, contact centre Qualiopi",
    canonicalUrl: "https://iacenter.fr/contact",
    ogImage: "https://iacenter.fr/favicon.png",
    schemaData: {
      "@context": "https://schema.org",
      "@type": "ContactPage",
      "name": "Contact IA Center | Formation Intelligence Artificielle",
      "description": "Contactez IA Center pour vos formations IA entreprises. Centre de formation intelligence artificielle certifié Qualiopi.",
    ...
    >
      <div className="section-padding">
        <div className="container-minimal">
          ...
          >
            Contactez IA Center - Centre de Formation Intelligence Artificielle
          </motion.h1>
          <motion.p
            variants={itemVariants}
            initial="hidden"
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              <h2 className="text-2xl font-semibold text-foreground">Coordonnées IA Center Paris</h2>
              ...
              {/* Google Maps Embed */}
              <div className="bg-background rounded-xl border-2 border-primary/20 overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300">
                {/* En-tête de la carte avec informations */}
                <div className="p-4 bg-gradient-to-r from-primary/10 via-primary/5 to-background border-b border-border">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 bg-primary/15 rounded-lg">
                      <img src="/favicon.png" alt="IA Center" className="h-7 w-7 object-contain" />
                    </div>
                    <div>
                      <p className="text-base font-bold text-foreground">IA Center</p>
                      <p className="text-sm text-muted-foreground">40 Rue Alexandre Dumas, 75011 Paris</p>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ width: '100%', height: '450px' }}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2714.1174510015912!2d2.3907110765635315!3d48.853592771331556!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e67275b8e04859%3A0xf47fd465b9845da4!2s40%20Rue%20Alexandre%20Dumas%2C%2075011%20Paris!5e1!3m2!1sfr!2sfr!4v1762992331629!5m2!1sfr!2sfr"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
                    ...
                    title="Localisation IA Center - 40 Rue Alexandre Dumas, 75011 Paris"
                  />
                </div>
                
                {/* Footer avec lien Google Maps */}
                <div className="p-4 bg-silver-light border-t border-border">
                  <a
                    href="https://maps.app.goo.gl/2PzeyWCvHz3F7ye77"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm font-semibold text-primary hover:text-primary/80 transition-colors inline-flex items-center gap-2 group w-full justify-center py-2 px-4 rounded-lg hover:bg-primary/5 transition-all duration-200"
                  >
                    <MapPin className="h-4 w-4 group-hover:scale-110 transition-transform duration-200" />
                    <span>Voir l'établissement sur Google Maps</span>
                    <svg 
