...
const AboutPage = () => {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="section-padding !pt-4 md:!pt-6"
    >
      <div className="container-minimal space-y-20 md:space-y-28">
        ...
        <motion.div variants={itemVariants} className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold text-foreground mb-4">Nos Partenaires</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Nous collaborons avec des partenaires de confiance pour vous offrir les meilleures solutions de formation
            </p>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 lg:gap-8 items-center justify-items-center">
            {/* Logo Constructys */}
            <motion.div
              whileHover={{ scale: 1.05, y: -5 }}
              transition={{ duration: 0.3 }}
              className="w-full max-w-[200px] h-[130px] bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-border/20 hover:border-primary/40 flex items-center justify-center p-6 group"
            >
              <img
            ...
            >
              <img
                src="/images/partenaires/logo-kairos-site-01.jpg"
                alt="Kairos"
                className="max-w-full max-h-full object-contain opacity-80 group-hover:opacity-100 transition-opacity duration-300"
              />
            </motion.div>
