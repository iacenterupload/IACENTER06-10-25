...
const AboutPage = () => {
  ...
  return (
    ...
    >
      {/* SEO Meta pour la page à propos */}
      <script type="application/ld+json">
      {JSON.stringify({
        "@context": "https://schema.org",
        "@type": "AboutPage",
        "name": "À propos IA Center | Centre de Formation Intelligence Artificielle",
        "description": "Découvrez IA Center, centre de formation intelligence artificielle certifié Qualiopi. Expertise IA, accompagnement PME, transition numérique, outils IA (ChatGPT, Midjourney).",
