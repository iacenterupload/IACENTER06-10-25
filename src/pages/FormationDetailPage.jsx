      ...
      >
        <div className="container-minimal max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Cette formation vous permet d'acquérir toutes les compétences nécessaires pour exercer en tant que Business Developer indépendant.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                Vous apprendrez à identifier votre marché, à prospecter efficacement, à vendre, fidéliser vos clients et à gérer votre propre activité commerciale.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                L'objectif est de vous rendre autonome dans le développement commercial — que ce soit pour votre propre entreprise ou en prestation pour d'autres structures.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                ...
                <div className="mt-4">
                  <h4 className="font-semibold text-foreground mb-3">4.1 L'approche directe du prospect</h4>
                  ...
                  <h4 className="font-semibold text-foreground mb-3">4.2 Vue d'ensemble de l'approche indirecte</h4>
                </div>
              </div>
