...
const getSEOData = (formation, specificData = {}) => {
  ...
  // Détecter si c'est une formation pro ou particuliers
  const isFormationPro = formationsPro.some(f => f.slug === formation.slug);
  const isFormationParticulier = formationsParticuliers.some(f => f.slug === formation.slug);
  
  // Métadonnées adaptées selon le type de formation
  const defaultTitle = isFormationParticulier 
    ? `${formation.title} | Formation Particulier IA | CPF | IA Center`
    : `${formation.title} | Formation Professionnelle IA | IA Center`;
  
  const defaultDescription = isFormationParticulier
    ? `${formation.description} Formation certifiée Qualiopi pour particuliers en France. Financement CPF ou fonds propres disponibles.`
    : `${formation.description} Formation certifiée Qualiopi pour entreprises en France. Inscription et financement OPCO disponibles.`;
  
  const defaultKeywords = isFormationParticulier
    ? `formation ${formation.title.toLowerCase()}, formation particulier France, formation CPF, formation certifiée Qualiopi, formation digitale, formation entrepreneur, formation en ligne France, financement CPF, formation fonds propres, formation payante, paiement direct formation, formation tarif`
    : `formation ${formation.title.toLowerCase()}, formation professionnelle France, formation entreprise, formation OPCO, formation certifiée Qualiopi, formation digitale, formation TPE PME, formation en ligne France`;
...
const FormationDetailPage = () => {
  ...
  if (formation.slug === 'creer-business-en-ligne') {
    const seoData = getSEOData(formation, {
      title: "Formation Créer son Business en Ligne | Entrepreneuriat Digital | Start-up Online | IA Center",
      description: "Formation entrepreneuriat digital : créez et développez votre business en ligne. Niche rentable, offre digitale, marketing, génération de revenus. 15h à 35h en ligne. Financement CPF ou fonds propres. Certification Qualiopi France.",
      keywords: "formation business en ligne, formation entrepreneuriat digital, formation créer entreprise online, formation start-up digitale, formation niche rentable, formation e-commerce, formation marketing digital entrepreneur, formation CPF business, formation fonds propres, formation payante, paiement direct formation, formation Qualiopi France",
      skills: [
        "Identifier une niche rentable",
        "Créer une offre digitale attractive",
        "Développer une présence en ligne",
        "Générer des revenus digital",
  ...
  if (formation.slug === 'reseaux-sociaux-entreprises') {
    const seoData = getSEOData(formation, {
      title: "Formation Réseaux Sociaux Entreprises | Instagram Facebook TikTok | Social Media Business | IA Center",
      description: "Formation réseaux sociaux pour entreprises : développez votre visibilité sur Instagram, Facebook, Messenger, TikTok et YouTube. 15h à 35h en ligne. Financement CPF ou fonds propres. Certification Qualiopi France.",
      keywords: "formation réseaux sociaux entreprise, formation Instagram Facebook, formation TikTok YouTube, formation social media business, formation marketing conversationnel, formation community management, formation CPF réseaux sociaux, formation fonds propres, formation payante, paiement direct formation, formation Qualiopi France",
      skills: [
        "Maîtriser les réseaux sociaux professionnels",
        "Créer du contenu engageant",
        "Développer une stratégie multi-plateformes",
        "Gérer une communauté active",
  ...
  // Contenu spécial pour Formation d'anglais sur mesure
  if (formation.slug === 'anglais-sur-mesure') {
    const seoData = getSEOData(formation, {
      title: "Formation Anglais sur Mesure | Perfectionnement Anglais | Remise à Niveau | CPF | IA Center",
      description: "Formation d'anglais sur mesure : du perfectionnement à la remise à niveau. Accompagnement individuel personnalisé. Entre 15h et 35h, 100% en ligne. Financement CPF ou fonds propres. Certification Qualiopi France.",
      keywords: "formation anglais sur mesure, formation perfectionnement anglais, formation remise à niveau anglais, formation anglais CPF, formation anglais entreprise, formation anglais professionnel, formation anglais en ligne, formation fonds propres, formation payante, paiement direct formation, formation Qualiopi anglais, formation CPF langue",
      skills: [
        "Comprendre et s'exprimer aisément à l'oral comme à l'écrit",
        "Acquérir un vocabulaire adapté à ses besoins personnels et professionnels",
        "Améliorer sa prononciation, son accent et sa fluidité",
        "Gagner en autonomie et en confiance dans les échanges en anglais",
        "Lire, rédiger et comprendre des documents en anglais avec précision"
      ]
    });
    useSEO(seoData);
        ...
        <div className="container-minimal max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
              Formation d'anglais sur mesure : du perfectionnement à la remise à niveau
            </h1>
            <div className="flex flex-col items-center gap-3 mb-6">
              <div className="inline-block bg-primary/10 text-primary px-6 py-2 rounded-full text-sm font-medium">
                Programme 100% personnalisé • Adapté à vos besoins
              </div>
              <div className="inline-block bg-green-500/10 text-green-600 dark:text-green-400 px-6 py-2 rounded-full text-sm font-medium">
                60-90€/h
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Cette formation vous permet d'améliorer votre niveau d'anglais, quel qu'il soit, grâce à un accompagnement individuel et une approche personnalisée. Que vous souhaitiez acquérir les bases, renforcer vos compétences professionnelles ou perfectionner votre expression orale, un formateur expert vous guide pas à pas pour atteindre vos objectifs linguistiques.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                L'accent est mis sur la pratique, la compréhension et la confiance à l'oral comme à l'écrit.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-4 mb-8 flex-wrap">
              <h2 className="text-3xl font-bold text-foreground">📘 Programme détaillé</h2>
              <div className="inline-block bg-blue-500/10 text-blue-600 dark:text-blue-400 px-6 py-2 rounded-full text-base font-medium">
                Parcours adaptatif
              </div>
            </div>
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 1 : Évaluation initiale et définition du parcours</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Test de positionnement pour évaluer votre niveau (de A1 à C1)</li>
                  <li>• Identification des besoins personnels et professionnels</li>
                  <li>• Définition d'objectifs clairs et réalistes</li>
                  <li>• Élaboration d'un parcours d'apprentissage entièrement personnalisé</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 2 : Compréhension orale – Développer l'écoute active</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Apprendre à comprendre différents accents et rythmes de parole</li>
                  <li>• Identifier les mots-clés et expressions essentielles d'un discours</li>
                  <li>• Exercer sa compréhension via des podcasts, vidéos et dialogues réels</li>
                  <li>• Décrypter les expressions idiomatiques et le langage courant</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 3 : Expression orale – Gagner en fluidité et confiance</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Pratiquer la conversation dans des contextes variés (quotidien, voyage, professionnel)</li>
                  <li>• Améliorer sa prononciation, son intonation et son rythme</li>
                  <li>• Dépasser la peur de parler grâce à des exercices interactifs</li>
                  <li>• Acquérir les bons réflexes pour des échanges naturels et efficaces</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 4 : Compréhension écrite – Lire et analyser des contenus authentiques</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Lire et comprendre différents supports (articles, emails, dialogues, textes de presse)</li>
                  <li>• Enrichir son vocabulaire et repérer les structures grammaticales</li>
                  <li>• Travailler sur le sens global et la précision du vocabulaire</li>
                  <li>• Développer une lecture fluide et analytique</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 5 : Expression écrite – Structurer et rédiger en anglais</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Apprendre à construire des phrases et paragraphes clairs</li>
                  <li>• Utiliser la grammaire et la conjugaison de façon naturelle</li>
                  <li>• Rédiger des textes selon différents contextes (emails, lettres, rapports, CV, etc.)</li>
                  <li>• Corriger ses erreurs les plus fréquentes et enrichir son expression écrite</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 6 : Mise en pratique et progression continue</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Exercices de mise en situation selon vos objectifs personnels ou professionnels</li>
                  <li>• Simulations de conversations réelles avec le formateur</li>
                  <li>• Révision des notions clés et auto-évaluation des progrès</li>
                  <li>• Conseils et outils pour entretenir votre niveau après la formation</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              <ul className="text-muted-foreground space-y-3">
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Comprendre et s'exprimer aisément à l'oral comme à l'écrit</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Acquérir un vocabulaire adapté à ses besoins personnels et professionnels</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Améliorer sa prononciation, son accent et sa fluidité</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Gagner en autonomie et en confiance dans les échanges en anglais</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Lire, rédiger et comprendre des documents en anglais avec précision</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              <ul className="text-muted-foreground space-y-3">
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Aucun niveau minimum requis – formation accessible à tous</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Disposer d'un ordinateur, smartphone ou tablette avec connexion Internet</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Être motivé à pratiquer régulièrement pour progresser durablement</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              ...
              <ul className="text-muted-foreground space-y-2">
                <li>• Formation accessible aux personnes en situation de handicap</li>
                <li>• Adaptation du rythme, des supports et des exercices selon les besoins individuels</li>
                <li>• Accompagnement personnalisé assuré tout au long du parcours</li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-center">
            <Link to="/formations-particuliers" className="inline-block mt-8 text-primary underline text-lg">← Retour à la liste des formations</Link>
          </div>
        </div>
      </motion.div>
    );
  ...
  // Contenu spécial pour Business Developer Indépendant
  if (formation.slug === 'business-developer-independant') {
    const seoData = getSEOData(formation, {
      title: "Formation Business Developer Indépendant | Développement Commercial Freelance | CPF | IA Center",
      description: "Formation Business Developer Indépendant : apprenez à prospecter, vendre, fidéliser et gérer votre activité commerciale en freelance. À partir de 20h, 100% en ligne. Financement CPF ou fonds propres. Certification Qualiopi France.",
      keywords: "formation business developer indépendant, formation développement commercial freelance, formation prospection commerciale, formation vente B2B, formation business development, formation freelance commercial, formation CPF business developer, formation fonds propres, formation payante, paiement direct formation, formation Qualiopi France",
      skills: [
        "Identifier son marché et cibler ses prospects",
        "Maîtriser les techniques de prospection directe et indirecte",
        "Vendre et convaincre avec les méthodologies SPIN, SONCAS, AIDA",
        "Contractualiser et facturer des clients",
        "Créer et gérer son activité en micro-entreprise"
      ]
    });
    useSEO(seoData);
      ...
      >
        <div className="container-minimal max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-4">
              Business Developer Indépendant
            </h1>
            <div className="inline-block bg-primary/10 text-primary px-6 py-2 rounded-full text-sm font-medium">
              À partir de 20h de formation • 100 % en ligne
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              <p className="text-lg text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Nous formons la nouvelle génération de business developers indépendants.</strong>
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                Cette formation vous permet d'acquérir toutes les compétences nécessaires pour exercer en tant que Business Developer indépendant. Vous apprendrez à identifier votre marché, à prospecter efficacement, à vendre, fidéliser vos clients et à gérer votre propre activité commerciale.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                <strong className="text-foreground">Maîtrisez les compétences essentielles au business développement et apprenez à générer de la croissance là où d'autres ne voient que des obstacles.</strong>
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                Nous vous apprenons à créer votre vivier de clients et devenez l'atout dont aucune entreprise ne peut se passer. L'objectif est de vous rendre autonome dans le développement commercial — que ce soit pour votre propre entreprise ou en prestation pour d'autres structures.
              </p>
            </div>
          </div>
          ...
          {/* Accompagnement */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-6">🤝 Accompagnement</h2>
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-8 shadow-lg border border-primary/20">
              <div className="flex items-center mb-4">
                <Users className="h-8 w-8 text-primary mr-4" />
                <h3 className="text-2xl font-semibold text-foreground">Sessions collectives hebdomadaires pour progresser et réussir</h3>
              </div>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Bénéficiez d'un accompagnement personnalisé avec des sessions collectives hebdomadaires qui vous permettront de progresser efficacement et de réussir votre transformation en Business Developer indépendant. Ces sessions vous offrent l'opportunité d'échanger avec d'autres apprenants, de partager vos expériences et de recevoir des retours constructifs de nos formateurs experts.
              </p>
            </div>
          </div>
          ...
          {/* Programme détaillé */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-8">📘 Programme</h2>
            <div className="space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  <div className="p-2 bg-blue-100 rounded-lg mr-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 1 : Introduction à l'activité de Business Developer Indépendant</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Définition et rôle du Business Developer</li>
                  <li>• Opportunités et modèles de rémunération</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 2 : Identifier son marché</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Étude de marché et segmentation</li>
                  <li>• Définition du client idéal (persona)</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 3 : Cibler ses prospects et préparer sa prospection</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Techniques de sourcing de prospects</li>
                  <li>• Digitaliser une base de prospects</li>
                  <li>• Alimenter et structurer un fichier de prospection</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 4 : Démarrer sa prospection commerciale</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Qu'est-ce qu'une approche directe ?</li>
                  <li>• Lexique de la prospection commerciale</li>
                  <li>• Technique n°1 : Préparer un cold calling / emailing ciblé</li>
                  <li>• Technique n°2 : Cold emailing de masse & analyse de résultats</li>
                  <li>• Technique n°3 : Cold messaging automatisé & analyse de résultats</li>
                  <li>• Vue d'ensemble de l'approche indirecte</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 5 : Savoir vendre et convaincre durant un rendez-vous</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Méthodologie SPIN</li>
                  <li>• Méthodologie SONCAS</li>
                  <li>• Méthodologie AIDA</li>
                  <li>• Techniques de closing et de négociation</li>
                  <li>• Gestion des objections et des refus</li>
                  <li>• Connaître son produit ou service sur le bout des doigts</li>
                  <li>• Identifier les différents profils clients</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 6 : Contractualisation auprès d'un client</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Points clés d'un contrat de vente et d'un devis signé</li>
                  <li>• Signature en ligne d'un contrat de vente</li>
                  <li>• Facturation et encaissement d'une vente</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 7 : Suivi et fidélisation client</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Gestion du cycle de vie client</li>
                  <li>• Techniques de fidélisation et d'upselling</li>
                  <li>• Gestion des réclamations et satisfaction client</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground">Module 8 : Créer et déclarer son activité</h3>
                </div>
                <ul className="text-muted-foreground space-y-2">
                  <li>• Comparatif des différents statuts (micro-entreprise, EURL, SASU, etc.)</li>
                  <li>• Immatriculation en micro-entreprise</li>
                  <li>• Gestion et obligations administratives</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          {/* Public visé */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-6">👥 Public visé</h2>
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              <ul className="text-muted-foreground space-y-3">
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Créateurs d'entreprise ou indépendants souhaitant structurer leur développement commercial</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Personnes en reconversion vers les métiers du commerce ou du business development</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Professionnels souhaitant travailler en freelance pour des entreprises</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              <p className="text-lg text-muted-foreground">
                Aucun prérequis technique ou commercial. La formation est accessible à toute personne motivée à apprendre les fondamentaux du business development.
              </p>
            </div>
          </div>
          ...
          {/* Modalités */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-6">💻 Modalités</h2>
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200">
              <ul className="text-muted-foreground space-y-3">
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Formation 100 % en ligne, accessible à tout moment</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Accompagnement collectif hebdomadaire et suivi individuel personnalisé</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Accès aux offres de missions partenaires à la fin du programme</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary mr-3">•</span>
                  <span>Évaluation finale : dossier de prospection + oral de négociation</span>
                </li>
              </ul>
            </div>
          </div>
  ...
  // Page générique standardisée pour toutes les formations restantes
  const defaultSeoData = getSEOData(formation);
  useSEO(defaultSeoData);
  
  // Déterminer le lien de retour selon le type de formation
  const isFormationPro = formationsPro.some(f => f.slug === formation.slug);
  const backLink = isFormationPro ? "/formations-professionnels" : "/formations-particuliers";
  ...
  return (
    ...
    >
      <div className="container-minimal max-w-4xl mx-auto">
        ...
        <div className="text-center">
          <Link to={backLink} className="inline-block mt-8 text-primary underline text-lg">← Retour à la liste des formations</Link>
        </div>
      </div>
    </motion.div>
  );
