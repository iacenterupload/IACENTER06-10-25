...
const FormationDetailPage = () => {
  ...
  if (formation.slug === 'creer-business-en-ligne') {
    const seoData = getSEOData(formation, {
      ...
      description: "Formation entrepreneuriat digital : créez et développez votre business en ligne. Niche rentable, offre digitale, marketing, génération de revenus. 15h à 35h en ligne. Financement CPF. Certification Qualiopi France.",
      keywords: "formation business en ligne, formation entrepreneuriat digital, formation créer entreprise online, formation start-up digitale, formation niche rentable, formation e-commerce, formation marketing digital entrepreneur, formation CPF business, formation Qualiopi France",
      skills: [
  ...
  if (formation.slug === 'reseaux-sociaux-entreprises') {
    const seoData = getSEOData(formation, {
      ...
      description: "Formation réseaux sociaux pour entreprises : développez votre visibilité sur Instagram, Facebook, Messenger, TikTok et YouTube. 15h à 35h en ligne. Financement CPF. Certification Qualiopi France.",
      keywords: "formation réseaux sociaux entreprise, formation Instagram Facebook, formation TikTok YouTube, formation social media business, formation marketing conversationnel, formation community management, formation CPF réseaux sociaux, formation Qualiopi France",
      skills: [
  ...
  if (formation.slug === 'anglais-sur-mesure') {
    const seoData = getSEOData(formation, {
      ...
      description: "Formation d'anglais sur mesure : du perfectionnement à la remise à niveau. Accompagnement individuel personnalisé. Entre 15h et 35h, 100% en ligne. Financement CPF. Certification Qualiopi France.",
      keywords: "formation anglais sur mesure, formation perfectionnement anglais, formation remise à niveau anglais, formation anglais CPF, formation anglais entreprise, formation anglais professionnel, formation anglais en ligne, formation Qualiopi anglais, formation CPF langue",
      skills: [
