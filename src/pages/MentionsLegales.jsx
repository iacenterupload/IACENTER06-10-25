...
const MentionsLegales = () => {
  return (
    ...
    >
      {/* SEO Meta pour mentions légales */}
      <script type="application/ld+json">
      {JSON.stringify({
        "@context": "https://schema.org",
        "@type": "WebPage",
        "name": "Mentions Légales | IA Center - Formation Intelligence Artificielle",
        "description": "Mentions légales IA Center. Centre de formation intelligence artificielle certifié Qualiopi. Informations légales, propriété intellectuelle, données personnelles.",
        "url": "https://iacenter.fr/mentions-legales",
        "mainEntity": {
          "@type": "Organization",
          "name": "IA Center",
          "legalName": "IA Center SASU",
          "address": {
            "@type": "PostalAddress",
