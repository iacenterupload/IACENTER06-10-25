...
const FormationsProPage = () => {
  ...
  const filterCategories = [
    ...
    { id: 'securite', label: 'Cybersécurité' }
  ];

  // Mapping des formations par catégorie
  const formationCategories = {
    marketing: [
      'opportunites-marketing-digital',
      'strategie-communication-digitale',
      'fiche-google-business-profile',
      'instagram-facebook-commerces',
      'demarrer-presence-en-ligne'
    ],
    transformation: [
      'transition-numerique',
      'digitaliser-process-internes'
    ],
    securite: [
      'securiser-donnees-pratiques-ligne'
    ]
  };
  ...
  const filteredFormations = activeFilter === 'toutes'
    ? formationsPro
    : formationsPro.filter(formation => 
  ...
  return (
    ...
    >
      ...
      <div className="container-minimal max-w-5xl mx-auto">
        <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-12 text-center">Formations Professionnelles</h1>
