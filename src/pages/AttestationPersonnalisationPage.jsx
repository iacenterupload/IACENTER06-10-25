...
const AttestationPersonnalisationPage = () => {
  ...
  return (
    ...
    >
      {/* SEO Meta pour attestation personnalisation */}
      <script type="application/ld+json">
      {JSON.stringify({
        "@context": "https://schema.org",
        "@type": "WebPage",
        "name": "Attestation Personnalisation | IA Center - Formation IA",
        "description": "Attestation des modalités de personnalisation de la formation IA Center. Centre de formation intelligence artificielle certifié Qualiopi.",
