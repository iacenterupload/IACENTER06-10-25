...
const PolitiqueConfidentialite = () => {
  const seoData = {
    title: "Politique de Confidentialité IA Center | Protection Données RGPD",
    description: "Politique de confidentialité IA Center. Protection des données personnelles, conformité RGPD, gestion cookies. Centre de formation intelligence artificielle certifié Qualiopi. CNIL, droits utilisateurs.",
    keywords: "politique confidentialité IA Center, RGPD formation, protection données personnelles, cookies formation, droits CNIL, confidentialité données, gestion données personnelles",
    canonicalUrl: "https://iacenter.fr/politique-confidentialite",
    ogImage: "https://iacenter.fr/favicon.png",
    schemaData: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Politique de Confidentialité | IA Center - Formation IA",
      "description": "Politique de confidentialité IA Center. Protection des données personnelles, RGPD.",
