    ...
    >
      <div className="container-minimal max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none mb-12">
          ...
          <p>
            Cette sous-utilisation représente un gâchis économique considérable : chaque année, votre entreprise verse une cotisation obligatoire calculée sur votre masse salariale (0,25% pour les PME de moins de 50 salariés, 1% au-delà), mais faute de mobilisation, cette contribution ne se transforme pas en investissement compétitif. C'est comme payer une assurance sans jamais réclamer de remboursement, ou investir dans un outil sans l'utiliser.
          </p>
          <p>
