      ...
      <div className="container-minimal max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none mb-12">
          <p className="text-xl text-muted-foreground leading-relaxed">
            La formation professionnelle dépasse largement le développement individuel : elle constitue un formidable outil de cohésion d'équipe et de stimulation de l'innovation collective. Quand une équipe suit une formation ensemble, elle partage une expérience commune, développe un langage commun, et crée des références communes. Cette dimension collective de la formation est souvent négligée, pourtant elle est précieuse.
          </p>
          <p>
            Cette formation collective stimule également l'innovation : nouvelles compétences acquises ensemble, connaissances croisées entre services, possibilité d'expérimentation collective. Ces leviers créent une dynamique d'innovation qui dépasse la simple somme des compétences individuelles.
          </p>
          <p>
            Cet article explore comment la formation renforce la cohésion d'équipe et stimule l'innovation collective. Vous découvrirez comment les formations communes créent du lien, comment les nouvelles compétences stimulent l'innovation, et comment allier formation, cohésion et innovation pour maximiser la performance collective.
          </p>
        </div>
