      ...
      <div className="container-minimal max-w-4xl">
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Comparons cette perte avec l'investissement formation : un programme de développement des compétences coûte en moyenne 800€ à 2 500€ par participant, souvent financé à 100% par l'OPCO. Ainsi, pour une PME de 25 personnes, un budget formation annuel de 15 000€ représente l'équivalent d'à peine 20% du coût d'un seul départ de cadre. La formation devient ainsi un investissement préventif particulièrement rentable : chaque euro investi en formation pour fidéliser évite plusieurs dizaines d'euros de coûts de turnover.
            </p>
