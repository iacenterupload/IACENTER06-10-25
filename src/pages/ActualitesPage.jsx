...
import { Newspaper, Calendar, TrendingUp, Users, Filter } from 'lucide-react';
...
const ActualitesPage = () => {
  ...
  const actualites = [
    {
      ...
      category: "OPCO & Financements",
      title: "Refus de prise en charge OPCO : les 7 raisons principales et solutions",
      excerpt: "Guide complet sur les refus de prise en charge OPCO. Les 7 raisons principales, solutions pratiques, procédures de recours et accompagnement IA Center.",
      link: "/blog/refus-prise-charge-opco-7-raisons-solutions",
      readingTime: "23 min"
    },
    {
      date: "16 novembre 2025",
      category: "OPCO & Financements",
      title: "Reliquat OPCO : comment récupérer un budget non utilisé",
      excerpt: "Guide complet pour récupérer vos reliquats OPCO avant expiration. Délais, procédures, risques de perte et solutions IA Center pour optimiser vos budgets formation.",
      link: "/blog/reliquat-opco-recuperer-budget-non-utilise",
      readingTime: "22 min"
    },
    {
      date: "15 novembre 2025",
      category: "OPCO & Financements",
      title: "DSN et OPCO : comment corriger une erreur de déclaration",
      excerpt: "Guide complet pour corriger une erreur DSN impactant votre OPCO (Constructys/AKTO). Procédure étape par étape, délais, risques et solutions IA Center.",
      link: "/blog/dsn-opco-corriger-erreur-declaration",
      readingTime: "21 min"
    },
    {
      date: "9 novembre 2025",
      category: "OPCO & Financements",
      title: "Constructys 2025 : sécuriser vos budgets “travaux sous tension”",
      excerpt: "Contrôles renforcés, DSN, IDCC et preuves chantier : comment éviter les refus de prise en charge Constructys avec la méthode IA Center.",
      link: "/blog/constructys-controles-travaux-sous-tension-2025",
      readingTime: "21 min"
    },
    {
      date: "5 novembre 2025",
      category: "OPCO & Financements",
      title: "AKTO 2025 : structurer un plan alternance gagnant",
      excerpt: "Mutualisation multi-sites, priorités de branches et financement complet : 90 jours pour sécuriser votre stratégie alternance AKTO.",
      link: "/blog/akto-plan-alternance-2025",
      readingTime: "22 min"
    },
    {
      date: "1er novembre 2025",
      category: "OPCO & Financements",
      title: "Constructys x AKTO : gérer les multi-activités et changements d'IDCC",
      excerpt: "Audit DSN, conventions, transferts de reliquats : la check-list IA Center pour sécuriser vos budgets OPCO multi-activités en 2025.",
      link: "/blog/constructys-akto-multi-activites-idcc",
      readingTime: "21 min"
    },
    {
      ...
      excerpt: "Priorités officielles, financements disponibles et roadmap IA Center pour transformer vos services éligibles chez AKTO.",
      link: "/blog/akto-digitalisation-services-2025",
      readingTime: "20 min"
    },
    {
      date: "24 octobre 2025",
      category: "OPCO & Financements",
      title: "Comment savoir si mon entreprise dépend de l'OPCO Constructys ou AKTO ?",
      excerpt: "DSN, IDCC, portails OPCO : toutes les étapes pour identifier rapidement votre rattachement et sécuriser vos budgets.",
      link: "/blog/comment-savoir-entreprise-opco-constructys-akto",
      readingTime: "18 min"
    },
    {
      date: "21 octobre 2025",
      category: "OPCO & Financements",
      title: "Budget formation AKTO : pourquoi 37 % disparaissent encore en 2025",
      excerpt: "Données 2025, checklist 90 jours et KPIs IA Center pour consommer 100 % de votre budget formation AKTO.",
      link: "/blog/pourquoi-entreprises-akto-perdent-budget-formation",
      readingTime: "22 min"
    },
    {
      date: "17 octobre 2025",
      category: "OPCO & Financements",
      title: "Mon entreprise cotise à un OPCO : comment en profiter concrètement ?",
      excerpt: "Portails, plan de développement des compétences et cofinancements : le playbook IA Center pour mobiliser vos cotisations.",
      link: "/blog/entreprise-cotise-opco-comment-profiter",
      readingTime: "20 min"
    },
    {
      date: "14 octobre 2025",
      category: "OPCO & Financements",
      title: "Le rôle des OPCO dans la transformation numérique des entreprises",
      excerpt: "Priorités digitales 2025, dispositifs de financement et méthode IA Center pour accélérer vos projets numériques.",
      link: "/blog/role-opco-transformation-numerique-entreprises",
      readingTime: "20 min"
    },
    {
  ...
  // Extraire toutes les catégories uniques et les trier
  const categories = useMemo(() => {
    const uniqueCategories = ['Tous', ...new Set(actualites.map(item => item.category).filter(Boolean))];
    // Trier les catégories : "Tous" en premier, puis par ordre alphabétique
  ...
  // Filtrer les actualités selon la catégorie sélectionnée
  const filteredActualites = useMemo(() => {
    if (selectedCategory === 'Tous') {
      return actualites;
    }
    return actualites.filter(actualite => actualite.category === selectedCategory);
  }, [actualites, selectedCategory]);
        ...
        >
          ...
          {actualites.length > 0 && (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg font-semibold text-foreground">Filtrer par catégorie :</h2>
              </div>
                  ...
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                      selectedCategory === category
                        ...
                        : 'bg-silver-light text-foreground hover:bg-silver-medium border border-silver-medium'
                    }`}
                  >
                    {category}
                  </motion.button>
          ...
          {actualites.length === 0 ? (
            ...
            <motion.div 
              ...
              className="text-center py-20 bg-silver-light rounded-lg border border-silver-medium"
            >
              <Newspaper className="h-20 w-20 mx-auto text-muted-foreground mb-6 opacity-50" />
              <h2 className="text-2xl font-semibold mb-4 text-foreground">
                Aucun article dans cette catégorie
              </h2>
              <p className="text-muted-foreground max-w-md mx-auto mb-8">
                Il n'y a pas encore d'articles dans la catégorie "{selectedCategory}". Consultez les autres catégories ou revenez bientôt !
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
