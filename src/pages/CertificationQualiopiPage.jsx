...
const CertificationQualiopiPage = () => {
  ...
  const seoData = {
    title: "Certification Qualiopi IA Center | Centre Formation Certifié | Qualité Formation",
    description: "IA Center est certifié Qualiopi par BCI France. Certificat N° CW202524-2607 valide jusqu'au 23/03/2028. Garantie qualité formations IA, éligible CPF et OPCO. France.",
    keywords: "certification Qualiopi, Qualiopi IA Center, centre formation certifié, certification qualité formation, BCI France, certificat Qualiopi, formation certifiée qualité, éligible CPF OPCO, certification France Compétences",
    canonicalUrl: "https://iacenter.fr/certification-qualiopi",
    ogImage: "https://iacenter.fr/favicon.png",
    schemaData: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Certification Qualiopi | IA Center - Formation IA",
      "description": "Certification Qualiopi IA Center. Centre de formation intelligence artificielle certifié Qualiopi. Garantie qualité formations IA.",
      ...
      "mainEntity": {
        ...
        "credentialId": "CW202524-2607",
        "validUntil": "2028-03-23",
        "recognizedBy": {
          "@type": "Organization",
          "name": "BCI France",
          "legalName": "Bureau de Certification International"
        },
        "about": {
        ...
        <div className="container-minimal max-w-6xl mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Certification Qualiopi IA Center - Certificat N° CW202524-2607
            </h1>
