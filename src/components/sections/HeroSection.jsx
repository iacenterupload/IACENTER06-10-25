  ...
  return (
    ...
    >
      <div className="relative z-10 container-minimal">
        ...
        >
          IA Center, l'Excellence de la Formation pour le Monde de Demain {/* Updated H1 */}
        </motion.h1>
        <motion.p
          variants={itemVariants}
          className="text-lg md:text-xl lg:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto" // Increased max-width
        >
          Formations Innovantes et Accessibles, afin de Développer vos Compétences et celles de vos Équipes dès Aujourd'hui. {/* Updated P */}
        </motion.p>
